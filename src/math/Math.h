...
float                                  distancePointLineSegment( const math::Vec3f &point, const Vec3f &p1, const Vec3f &p2 ); // returns the distance of the given point to the segment specified by two points
/*
